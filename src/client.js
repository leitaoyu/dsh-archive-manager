...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		/**
		* Provide the Workspace navigation capability introduced by DSH 0.1.2.
		* The archive manager replaces the stock ui-workspace row, so it must also
		* preserve the service that alpha-era sidebar/conversation plugins wait for.
		* Older hosts do not consume this service, making the provider harmless there.
		* @param ctx - client root context.
		* @returns disposer for the compatibility service, or a no-op when supplied.
		*/
